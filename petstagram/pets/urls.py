...
from pets.views import list_pets, pet_details_or_comment_pet, like_pet, edit_pet, delete_pet, create_pet

urlpatterns = [
    path('', list_pets, name='list pets'),
    path('detail/<int:pk>/',pet_details_or_comment_pet, name='pet details or comment'),
